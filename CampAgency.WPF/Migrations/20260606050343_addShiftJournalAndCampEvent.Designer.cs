...
namespace CampAgency.WPF.Migrations
{
    ...
    [Migration("20260606050343_addShiftJournalAndCampEvent")]
    partial class addShiftJournalAndCampEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampAgency.WPF.Models.Entities.CampEvent", b =>
                {
                    b.Property<int>("CampEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CampEventId"));
            ...
            modelBuilder.Entity("CampAgency.WPF.Models.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("CampAgency.WPF.Models.Entities.ShiftJournal", b =>
                {
                    b.Property<int>("ShiftJournalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShiftJournalId"));
            ...
            modelBuilder.Entity("CampAgency.WPF.Models.Entities.ShiftJournal", b =>
                {
                    b.HasOne("CampAgency.WPF.Models.Entities.CampEvent", "CampEvent")
                        .WithMany("ShiftJournals")
                    ...
                    b.HasOne("CampAgency.WPF.Models.Entities.User", "Operator")
                        .WithMany("ShiftJournals")
